...
/** @type {string} */
const CACHE_VERSION = '1785859227|261528904';
/** @type {string} */
const CACHE_PREFIX = 'Quiz Survivor-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'quiz-survivor.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["quiz-survivor.html","quiz-survivor.js","quiz-survivor.offline.html","quiz-survivor.icon.png","quiz-survivor.apple-touch-icon.png","quiz-survivor.worker.js","quiz-survivor.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["quiz-survivor.wasm","quiz-survivor.pck"];
